...
const MODULES: ModuleCard[] = [
  ...
  { title: "Assembly Queue", description: "Bikes sold before assembly", icon: PackageCheck, to: "/assembly-queue", permission: "motorcycle.read" },
  { title: "Service Follow-up", description: "When sold bikes are due for service", icon: CalendarClock, to: "/service-followup", permission: "motorcycle.read" },
