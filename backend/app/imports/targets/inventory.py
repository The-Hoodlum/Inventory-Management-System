...
_FIELDS: tuple[FieldSpec, ...] = (
    ...
    FieldSpec("warehouse", "Warehouse", kind=FieldKind.STRING, levels=_STD,
              aliases=("store", "site", "warehouse name")),
    FieldSpec("location", "Location", kind=FieldKind.STRING, levels=_STD,
              aliases=("location", "bin", "shelf", "aisle", "bin location",
                       "storage location", "rack", "slot")),
    ...
    FieldSpec("selling_price", "Selling Price", kind=FieldKind.DECIMAL, levels=_ADV,
              aliases=("price", "sell price", "retail price", "retail", "sale price", "unit price")),
    FieldSpec("wholesale_price", "Wholesale Price", kind=FieldKind.DECIMAL, levels=_ADV,
              aliases=("wholesale", "wholesale price", "trade price", "bulk price")),
